   ...
   public function __construct()
   {
	...
	{	
		...
		if(in_array($current,$dupids))
		{
			...
			$this->context->controller->addJS(($this->_path).'js/backbutton.js');
		}
		$id_customer=$this->context->cookie->id_customer;
		if($id_customer=="")
		{
	...
	{	
		...
		{		
			...
			{
				header("location: index.php?id_product=".$cookie->redirect."&controller=product");
			}
			$cookie->redirect="";
			$cookie->lastproduct="";
			$cookie->chain="";
